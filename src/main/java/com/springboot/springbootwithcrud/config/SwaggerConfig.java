/*
 * package com.springboot.springbootwithcrud.config;
 * 
 ...
 * 
 * private ApiInfo apiInfo() { return new ApiInfoBuilder() .title("Product API")
 * .description("This application will handle all product reletaed information")
 * .version("1.0.0") .termsOfServiceUrl("http://java.com")
 * .license("Product License") .licenseUrl("http://java.com") .build(); } }
 */